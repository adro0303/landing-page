...
export const stackExperience: Record<string, { en: string; es: string }> = {
  ...
  JavaScript: { en: "6+ mo", es: "6+ meses" },
  Java: { en: "6+ mo", es: "6+ meses" },
  "C++": { en: "6+ mo", es: "6+ meses" },
  HTML5: { en: "6+ mo", es: "6+ meses" },
  CSS3: { en: "6+ mo", es: "6+ meses" },
  ...
  Streamlit: { en: "6+ mo", es: "6+ meses" },
  "CLI design": { en: "1-2 yr", es: "1-2 años" },
  "YAML configs": { en: "1-2 yr", es: "1-2 años" },
  SMTP: { en: "6+ mo", es: "6+ meses" },
  n8n: { en: "6+ mo", es: "6+ meses" },
  ComfyUI: { en: "1-2 yr", es: "1-2 años" },
  "Kokoro TTS": { en: "6+ mo", es: "6+ meses" },
  ffmpeg: { en: "6+ mo", es: "6+ meses" },
  ...
  "React 19": { en: "6+ mo", es: "6+ meses" },
  TypeScript: { en: "1+ yr", es: "1+ año" },
  Vite: { en: "6+ mo", es: "6+ meses" },
  "Tailwind CSS": { en: "1-2 yr", es: "1-2 años" },
  GSAP: { en: "6+ mo", es: "6+ meses" },
  "Framer Motion": { en: "6+ mo", es: "6+ meses" },
};
